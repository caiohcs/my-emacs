...
(use-package hydra
  ...
  (defhydra hydra-avy (:color blue :hint nil)
    "
    _s_: word    _n_: word bellow   _p_: word above
    "
    ("q" nil "quit")
    ("s" avy-goto-word-1)
  ...
  _F_: next char   _B_: prev char  _g_: avy word    _<_: beg buffer  _>_: end buffer
  ...
  (global-set-key (kbd "<f1>") '(lambda () (interactive) (set-cursor-color "#ff0000") (setq hydra-is-helpful nil) (hydra-movement/body)))
```
