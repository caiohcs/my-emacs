...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (pacmacs btc-ticker horoscope exec-path-from-shell counsel swiper go-errcheck dracula-theme zenburn-theme use-package slime moe-theme ivy go-mode docker company))))
(custom-set-faces
